  ...
  function editProtocol(id, name, result) {
      ...
      var options = {
          ...
          onAfterShow: function () {
              ...
              $("#applyPay-moneyAmount").val(NumberFormatUtil.fmoney(result.moneyAmount,2))
              $("#applyPay-serviceFee").val(NumberFormatUtil.fmoney(result.serviceFee,2))
              $("#applyPay-poundage").val(NumberFormatUtil.fmoney(result.poundage,2))
              $("#applyPay-agreeEnsureMoney").val(NumberFormatUtil.fmoney(result.agreeEnsureMoney,2))
              $("#applyPay-channelEnsureMoney").val(NumberFormatUtil.fmoney(result.channelEnsureMoney,2))
              $("#applyPay-licensePlateEnsureMoney").val(NumberFormatUtil.fmoney(result.licensePlateEnsureMoney,2))
              $("#applyPay-amountMoney").val(NumberFormatUtil.fmoney(result.amountMoney,2))
