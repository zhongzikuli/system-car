...
function exportExcel() {
	...
	confirmDialog("您确定要导出记录？", function () {
		...
		frame.attr("src", ctx + "/cfFinancialStatements/exportList.action?idArr=" + idArr.toString());
...
function exporBudgettExcel() {
	...
	confirmDialog("您确定要导出记录？", function () {
		var frame = $('<iframe>');//定义一个iframe
		frame.attr("src", ctx + "/cfFinancialStatements/exportBudgetStatisticsList.action?idArr=" + idArr.toString());
		frame.attr("style", "display:none");
		frame.append("</iframe>")
		$("body").append(frame);
