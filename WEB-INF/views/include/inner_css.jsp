...
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/styles/third/fontAwesome/font-awesome.min.css">
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/styles/third/animate/animate.min.css">
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/js/third/chosen/chosen.css">
<link rel="stylesheet" type="text/css" href="<%=request.getContextPath() %>/styles/mine/base.css">
