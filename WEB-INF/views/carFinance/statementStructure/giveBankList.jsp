...
<div class="mod_header">
    ...
    <form id="pagerForm" action="${ctx}/graphicReport/giveBankList.action" method="post" style="margin:0;">
        ...
        <div class="row">
            <div class="col-sm-5">
                ...
                <a data-toggle="modal" class="btn btn-info btn-sm" onclick="exportExcel('/graphicReport/export/dailyMonthToBank.action')">导出</a>
            </div>
        </div>
    </form>
</div>
        ...
        <div class="table-responsive full-height">
            <table class="table table-hover table-height table-striped">
                ...
                <tr>
                    ...
                    <c:if test="${queryType=='送交合同金额'}">
                        <th style="width:5%;">垫付金额(元)</th>

                    </c:if>
                    <c:if test="${queryType=='放款金额'}">
                        <th style="width:5%;">银行放款金额(元)</th>
                    </c:if>
                ...
                <c:forEach var="item" items="${pageBean.recordList}" varStatus="st">
                    <tr>
                        ...
                        <c:if test="${queryType=='放款金额'}">
                            <td class="cel"><sl:format type="number" show="${item.bankPaymentMoney}" pattern="#,##0.00"/></td>
