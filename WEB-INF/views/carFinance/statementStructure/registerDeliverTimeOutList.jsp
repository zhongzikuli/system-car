...
<div class="mod_header">
    ...
    <form id="pagerForm" action="${ctx}/graphicReport/registerDeliverTimeOutList.action" method="post" style="margin:0;">
        ...
        <div class="row">
            <div class="col-sm-5">
                ...
                <a data-toggle="modal" class="btn btn-info btn-sm" onclick="exportExcel('/graphicReport/export/registerDeliverTimeOut.action')">导出</a>
            </div>
        </div>
    </form>
</div>
