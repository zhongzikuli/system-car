...
<div class="mod_header">
    ...
    <form id="pagerForm" action="${ctx}/creditNotGiveBank/query.action" method="post">
            ...
            <div class="col-sm-11">
                <div class="form-inline">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control w-200" onkeyup="value=value.replace(/\s/g,'')"  name="keyword" id="search-keyword" placeholder="请输入客户姓名或身份证号" value="${keyword}">
                    </div>
                    <div class="form-group">
        ...
        <div class="table-responsive full-height">
            <table class="table table-hover table-height table-striped">
                ...
                <tr>
                    ...
                    <td class="cel"><sl:format type="number" show="${item.contractPrice+ item.installmentPayPoundage}" pattern="#,##0.00"/></td>
