...
<div class="mod_header">
    ...
    <form id="pagerForm" action="${ctx}/hasAdvances/query.action" method="post">
                            ...
                            <select name="userName" id="search-user" class="form-control chosen-select status" >
                                ...
                                <c:forEach items="${userList}" var="user">
                                    <option value="${user.userName}"
                                            <c:if test="${user.userName eq userName}">selected</c:if>
...
<script type="text/javascript" src="${ctx}/js/mine/carFinance/statementStructure/hasAdvances.js"></script>
</html>
