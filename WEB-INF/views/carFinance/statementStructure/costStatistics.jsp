...
<div class="mod_header">
    ...
    <form id="pagerForm" action="${ctx}/costStatistics/query.action" method="post">
        ...
        <div class="table-responsive full-height">
            <table class="table table-hover table-height table-striped">
                ...
                <tr>
                    ...
                    <th style="width:5%;">贷款金额</th>
                    <th style="width:5%;">贷款年限</th>
                    <th style="width:5%;">按揭服务费</th>
                    <th style="width:5%;">渠道保证金</th>
                    <th style="width:5%;">上牌押金</th>
                    <th style="width:5%;">按揭手续费</th>
                    <th style="width:5%;">履约保证金</th>
