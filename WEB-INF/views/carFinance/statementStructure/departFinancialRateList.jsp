...
<div class="mod_header">
    ...
    <form id="pagerForm" action="${ctx}/financialRate/listDepart.action" method="post" style="margin:0;">
        ...
        <div class="row">
            <div class="col-sm-11  text-left">
                <div class="form-inline">
                    ...
                    <a data-toggle="modal" class="btn btn-info btn-sm" onclick="exportFinancialExcelDepart('/financialRate/listDepartExport.action')">导出</a>
        ...
        <div class="table-responsive full-height">
            <table class="table table-hover table-height table-striped">
                ...
                <tr>
                    ...
                    <th style="width:6%;">资金占用天数(天)</th>
                    <th style="width:6%;">资金占用金额(元)</th>
                    <th style="width:6%;">银行放款日期</th>
                    <th style="width:6%;">贷款合同齐全日期</th>
                    <th style="width:6%;">合同送行日期</th>
                    <th style="width:6%;">所属<c:if test="${type eq 'month'}">月</c:if><c:if test="${type eq 'year'}">年</c:if></th>
