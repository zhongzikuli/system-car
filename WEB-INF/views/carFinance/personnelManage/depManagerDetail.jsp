...
<div class="mod_header">
    ...
    <form id="pagerForm" action="${ctx}/departmentDumpOutCheck/detail.action" method="post" style="margin:0;">
        <input type="hidden"  name="departmentManagerId" value="${departmentManagerId}">
        ...
        <div class="table-responsive full-height">
            <table class="table table-hover table-height table-striped">
                ...
                <tr>
                    ...
                    <th style="width:5%;">部门贷款额(元)</th>
                    <th style="width:8%;">业务员数</th>
                    <th style="width:8%;">人均贷款额(元)</th>
                </tr>
                </thead>
                <tbody>
                ...
                <c:forEach var="item" items="${pageBean.recordList}" varStatus="st">
                    <tr>
                        ...
                        <td >${item.month}</td>
                        <td >
                            <sl:format type="number" show="${item.loanMoney}" pattern="#,##0.00"/>
                        </td>
                        <td >${item.saleNum}</td>
                        <td >
                            <sl:format type="number" show="${item.avgLoanMoney}" pattern="#,##0.00"/>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
...
<script type="text/javascript" src="${ctx}/js/mine/carFinance/personnelManage/depManagerDetail.js"></script>
</html>
