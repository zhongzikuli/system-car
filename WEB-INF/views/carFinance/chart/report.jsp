		...
		<div class="wrapper wrapper-content">
		        ...
		        <div class="title-item-8 text-right">
		            <div class="form-inline">
		                <div class="form-group">
								...
								data-parentid="${sysOrgan.parentId}"  data-value="${sysOrgan.orgName}" value="${sysOrgan.orgName}">
		    ...
		    <div class="echart">
		        ...
		        <div class="echart-item-4 b-1">
                    ...
                    <div id="rate" style="width:100%; height: 275px;">
...
<script type="text/javascript" src="${ctx}/js/mine/carFinance/chart/report.js"></script>
</html>