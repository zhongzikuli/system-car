...
<div class="mod_header">
    ...
    <form id="pagerForm" action="${ctx}/cfMortgageRegist/queryForAudit.action" method="post">
                	...
                	<div class="row">
            			<div class="col-sm-7">
            				<div class="form-group">
            					<label class="col-xs-4 control-label">抵押登记提交时间:</label>
                                <div class="col-xs-8">
            ...
            <div class="table-responsive full-height">
                <table class="table table-hover table-height table-striped">
                    ...
                    <tr>
                        ...
                        <th style="width:8%;">抵押登记审核时间</th>
                        <th style="width:4%;">抵押登记状态</th>
                        <th style="width:7%;">抵押登记提交时间</th>
...
<script type="text/javascript" src="${ctx}/js/mine/carFinance/audit/mortgageList.js"></script>
</html>
