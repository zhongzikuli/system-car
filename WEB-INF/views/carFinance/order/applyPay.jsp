...
<div class="mod_header">
    ...
    <form id="pagerForm" action="${ctx}/applyPay/applyPayList.action" method="post" style="margin:0;">
            ...
            <div class="col-sm-10">
                <div class="form-inline">
                    <div class="form-group">
                        <label class="control-label label">垫款申请状态:</label>
                            ...
                            <td class="cel">
                             ...
                             <td class="btn-cel" style="min-width:120px;">
                                ...
                                <c:if test="${item.orderStatus==13||item.orderStatus==14}">
                                    <a href="#" data-id="${item.id}" data-name="${item.realName}"
...
<script type="text/javascript" src="${ctx}/js/mine/carFinance/order/applyPay.js"></script>
        ...
        <form id="applyPayCreateForm" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6" style="padding-right: 2px; padding-left: 2px;">
                  <label class="col-xs-4 control-label">按揭手续费(元):</label>
                    <div class="col-xs-7">
                        <input type="text" class="form-control" name="applyPay-poundage" id="applyPay-poundage"
                           readonly="readonly"      >
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6" style="padding-right: 2px; padding-left: 2px;">
                    ...
                    <div class="col-xs-7">
                        <input type="text" class="form-control" name="applyPay-agreeEnsureMoney" id="applyPay-agreeEnsureMoney"
                           readonly="readonly"      >
                    </div>
                </div>
				<div class="col-sm-6" style="padding-right: 2px; padding-left: 2px;">
                    ...
                    <div class="col-xs-7">
                        <input type="text" class="form-control" name="applyPay-channelEnsureMoney" id="applyPay-channelEnsureMoney"
                            readonly="readonly"    >
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="col-sm-6" style="padding-right: 2px; padding-left: 2px;">
                    ...
                    <div class="col-xs-7">
                        <input type="text" class="form-control" name="applyPay-licensePlateEnsureMoney" id="applyPay-licensePlateEnsureMoney"
                          readonly="readonly"      >
                    </div>
                </div>
            </div>
