...
<div class="mod_header">
    ...
    <form id="pagerForm" action="${ctx}/financialBudgetStatisticalReport/queryForBudgetStatisticsReport.action" method="post">
        <%@include file="/WEB-INF/views/include/pageForm.jsp" %>
        <div class="row">
        	<div class="col-sm-11  text-left">
                    <div class="form-inline">
	                    <shiro:hasPermission name="financeStatements:exporBudgetStatisticsList">
	                		<a type="button" class="btn btn-success btn-sm refresh-btn" onclick="exporBudgettExcel()">导出</a>
	             		</shiro:hasPermission>
                    ...
                    <c:forEach var="item" items="${pageBean.recordList}" varStatus="st">
                        <tr>
                            ...
                            <sl:format type="number" show="${item.repayMonth}" pattern="#,##0.00"/></td>
                             <td class="cel">
                            <sl:format type="number" show="${item.serviceFee}" pattern="#,##0.00"/></td>
                             <td class="cel">
                            <sl:format type="number" show="${item.poundage}" pattern="#,##0.00"/></td>
                             <td class="cel">
