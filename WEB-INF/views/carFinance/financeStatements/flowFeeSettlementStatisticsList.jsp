...
<div class="mod_header">
    ...
    <form id="pagerForm" action="${ctx}/flowFeeSettlementStatisticsReport/queryForFlowFeeSettlementStatisticsReport.action" method="post">
        <%@include file="/WEB-INF/views/include/pageForm.jsp" %>
        <div class="row">
        	<div class="col-sm-11  text-left">
                    <div class="form-inline">
	                    <shiro:hasPermission name="financeStatements:exporFlowFeeSettlementList">
	                		<a type="button" class="btn btn-success btn-sm refresh-btn" onclick="exporSettlementExcel()">导出</a>
	             		</shiro:hasPermission>
	                </div>
                </div>
            ...
            <div class="table-responsive full-height">
                <table class="table table-hover table-height table-striped">
                    ...
                    <tr>
                        ...
                        <th style="width:8%;">订单费用(元)</th>
                        <th style="width:8%;">同盾策略次数</th>
                        <th style="width:8%;">同盾策略费用(元)</th>
                        <th style="width:8%;">同盾手机在网时长次数</th>
                        <th style="width:8%;">同盾手机在网时长费用(元)</th>
                        <th style="width:8%;">百融策略次数</th>
                        <th style="width:8%;">百融策略费用(元)</th>
                        <th style="width:8%;">百融手机在网时长次数</th>
                        <th style="width:8%;">百融手机在网时长费用(元)</th>
                        <th style="width:8%;">百融手机三要素核验次数</th>
                        <th style="width:8%;">百融手机三要素核验费用(元)</th>
                        <th style="width:8%;">百融自然人征信查询次数</th>
                        <th style="width:8%;">百融自然人征信查询费用(元)</th>
                        <th style="width:8%;">身份证网格照查询次数</th>
                        <th style="width:8%;">身份证网格照查询费用(元)</th>
