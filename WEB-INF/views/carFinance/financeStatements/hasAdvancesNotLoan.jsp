...
<div class="mod_header">
    ...
    <form id="pagerForm" action="${ctx}/hasAdvancesNotLoan/hasAdvancesNotLoanlist.action" method="post">
        <%@include file="/WEB-INF/views/include/pageForm.jsp" %>
        <div class="row">
                <div class="col-sm-11  text-left">
                    <div class="form-inline">
	                   <shiro:hasPermission name="financeStatements:hasAdvancesNotLoan">
...
<script type="text/javascript" src="${ctx}/js/mine/carFinance/financialStatement/hasAdvancesNotLoan.js"></script>
</html>
