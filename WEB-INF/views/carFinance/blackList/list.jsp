            ...
            <div class="col-sm-10">
                <div class="form-inline">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="keyword" id="search-keyword" onkeyup="value=value.replace(/\s/g,'')"
                        ...
                        <tr>
                            ...
                            <td class="cel">${item.remark}</td>
                             <td class="btn-cel">
                                ...
                                <a data-toggle="modal" class="btn btn-info btn-xs detail"  href="${ctx}/cfBusinessOrderAccept/detail.action?id=${item.businessOrderAcceptId}&active=buyerInfo">
...
<script type="text/javascript" src="${ctx}/js/mine/carFinance/blackList/list.js"></script>
