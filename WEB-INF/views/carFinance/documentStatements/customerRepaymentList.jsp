...
<div class="mod_header">
    <div id="hiddenForm">
        ...
        <input  type="hidden" name="isRepmentDay" value="${paramMap.isRepmentDay}">
    </div>
    <form id="pagerForm" action="${ctx}/customerRepayment/query.action" method="post" style="margin:0;">
        ...
        <div class="row">
            <div class="col-sm-6 text-left">
                ...
                <c:if test="${ not empty customerRepaymentEntity}">
                    <label class="alert-warning">月还款额(万元): </label>
                    <code class="alert-info"><sl:format type="number" show="${customerRepaymentEntity.repayMonth/10000}" pattern="#,##0.00"/></code>
                    <label class="alert-warning">合同价(万元): </label>
                    <code class="alert-info"><sl:format type="number" show="${customerRepaymentEntity.contractPrice/10000}" pattern="#,##0.00"/></code>
                    <label class="alert-warning">贷款额(万元): </label>
                    <code class="alert-info"><sl:format type="number" show="${customerRepaymentEntity.actualLoadMoney/10000}" pattern="#,##0.00"/></code>
                </c:if>
                ...
                <div class="btn-box animated fadeInRight">
                    <div class="row">
                        <div class="col-sm-7">
                            ...
                            <div class="form-group">
                                <label class="col-xs-3 control-label">首期还款日</label>
                                <div class="col-xs-8">
                                    <select class="form-control" id="isRepmentDay" name="isRepmentDay">
                                        <option value="">请选择</option>
                                        <option value="1" <c:if test="${paramMap.isRepmentDay == '1'}">selected</c:if>>是</option>
                                        <option value="2" <c:if test="${paramMap.isRepmentDay == '2'}">selected</c:if>>否</option>
                                    </select>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript" src="${ctx}/js/mine/carFinance/documentStatements/customerRepaymentList.js"></script>
</html>
