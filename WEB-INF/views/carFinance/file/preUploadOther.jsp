    ...
    <form id="pagerForm" action="${ctx}/advert/query.action" method="post" style="margin:0;">
        ...
        <div class="row">
            ...
            <shiro:hasPermission name="uploadOther:save">
                ...
                <shiro:hasPermission name="uploadOther:delete">
                ...
                <shiro:hasPermission name="uploadOther:download">
...
<script type="text/javascript" src="<%=request.getContextPath() %>/js/mine/carFinance/file/uploadOther.js"></script>
