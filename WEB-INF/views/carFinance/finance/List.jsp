...
<div class="mod_header">
    ...
    <form id="pagerForm" action="${ctx}/financial/queryForAdvanced.action" method="post">
            ...
            <div class="table-responsive full-height">
                <table class="table table-hover table-height table-striped">
                    ...
                    <tr>
                        ...
                        <th style="width:7%;">银行放款日期</th>
                        <th style="width:5%;">财务垫款</th>
...
<script type="text/javascript" src="${ctx}/js/mine/carFinance/finance/List.js"></script>
</html>
