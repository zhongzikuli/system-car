...
<div class="mod_header">
    <div id="hiddenForm">
         <input type="hidden" name="feeConfirmStatus" value="${paramMap.feeConfirmStatus}"/>
    ...
    <form id="pagerForm" action="${ctx}/financial/queryForCasCheck.action" method="post">
        <%@include file="/WEB-INF/views/include/pageForm.jsp" %>
        <div class="row">
        	<div class="col-sm-2">
	        	<%-- <c:if test="${paramMap.feeConfirmStatus == 0}">
                 	...
                 	<div class="col-sm-7">
	                    ...
	                    <div class="form-group">
	                          <label class="col-xs-3 control-label">复核状态:</label>
		                        <div class="col-xs-8">
			                        <select class="form-control" id="search-style" name="feeConfirmStatus">
			                             <option value="-1" <c:if test="${paramMap.feeConfirmStatus == -1}">selected</c:if>>全部</option>
	                           			<option value="0" <c:if test="${paramMap.feeConfirmStatus == 0}">selected</c:if>>未复核</option>
	                            		<option value="1" <c:if test="${paramMap.feeConfirmStatus == 1}">selected</c:if>>已复核</option>
			                        </select>
		                      </div>
	                    </div>
                    ...
                    <c:forEach var="item" items="${pageBean.recordList}" varStatus="st">
                        <tr>
                            ...
                            <td class="cel">
                             ...
                             <td class="btn-cel">
                             <c:if test="${item.feeConfirmStatus<1}">
...
<script type="text/javascript" src="${ctx}/js/mine/carFinance/finance/casCheck.js"></script>
</html>
