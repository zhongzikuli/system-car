...
<div class="mod_header">
 <div id="hiddenForm">
    ...
    <form id="pagerForm" action="${ctx}/accommodationApply/queryApplyList.action" method="post">
            ...
            <div class="col-sm-10">
                <div class="form-inline">
	                <div class="form-group">
	                    ...
	                    <label class="control-label label">通融申请状态:</label>
	               ...
	               <%--     <div class="form-group" id="date-time">
                        <label class="control-label label">自动审核时间:</label>
                ...
                <table class="table table-hover table-height table-striped">
                    ...
                    <tr>
	                    ...
	                    <th style="width: 8%">订单状态</th>
                            <th style="width: 10%">自动审核时间</th>
	                    <th style="width: 10%">通融申请时间</th>
                    ...
                    <c:forEach var="item" items="${pageBean.recordList}" varStatus="st">
                        <tr>
                            ...
                            <td class="cel">
                                <fmt:formatDate value="${item.autoAuditTime}" pattern="yyyy-MM-dd HH:mm"/>
                            </td>
                            <td class="cel">
                                <fmt:formatDate value="${item.specialApplyTime}" pattern="yyyy-MM-dd HH:mm"/>
                            </td>
                             <td class="btn-cel" style="min-width:120px;">
                            <c:if test="${item.specialAuditStatus==2}">
                                <a data-toggle="modal" class="btn btn-danger btn-xs refuse-credit" data-id="${item.id}">通融申请</a>
                            </c:if>
                               <shiro:hasPermission name="order:track">
                                    <a title="订单轨迹" class="btn btn-success btn-xs"
                                       onclick="toOrderTrack('${item.id}','${ctx}/accommodationApply/queryApplyList.action')">订单轨迹</a>
                                </shiro:hasPermission>  
...
<script type="text/javascript" src="<%=request.getContextPath() %>/js/mine/carFinance/file/accommodationApply.js"></script>
    ...
    <div class="ibox-content">
        <form id="protocolCreateForm" class="form-horizontal">
            <div id="protocolCreateDialog" style="margin:10px;">
                <div class="form-group">
                    <label class="col-xs-3 control-label"><span class="red">*</span>通融备注:</label>
                    <div class="col-xs-8">
