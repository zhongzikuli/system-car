            ...
            <table class="table table-hover table-height table-striped">
                ...
                <c:forEach var="item" items="${pageBean.recordList}" varStatus="st">
                    <tr>
                        ...
                        <td class="cel" title="${item.orgName}">${item.orgName}</td>
                        <td class="cel" title="${item.orgTypeName}">${item.orgTypeName}</td>
                        <td class="cel"
                            title="${item.province}${item.city}${item.town}">${item.province}-${item.city}-${item.town}</td>
                        <td class="cel" title="${item.userName}">${item.userName}</td>
                        <td class="cel" title="${item.orgTel}">${item.orgTel}</td>
                        <td class="cel"><fmt:formatDate value="${item.ctime}"
                                                        pattern="yyyy-MM-dd HH:mm"/></td>
                        <td class="cel">
                            <c:if test="${item.isvalid == 1}"><code
                                    class="text-success">${item.statusName}</code></c:if>
                            <c:if test="${item.isvalid == 0}"><code class="text-danger">${item.statusName}</code></c:if>
                        </td>
                        <td class="btn-cel">
                            ...
                            <a href="#"  class="btn btn-primary btn-xs  organFee" data-id="${item.id}" data-name="${item.orgName}">
                                <i class="fa fa-edit"></i>费用管理</a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
            ...
            <div id="createOrgan" class="form-content">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <input type="text" name="userName" id="create-user-name" tip="请输入管理员" autocomplete="off"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            ...
                            <input type="password" name="userPassword" id="create-pass" tip="请输入密码" autocomplete="off"
                                   class="form-control" check="validOrgForm(this)"/>
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="col-xs-8">
                            <input type="text" name="employees" id="create-user-employees" tip="请输入员工人数" class="form-control" />
                        </div>
                    </div>
                </div>
            ...
            <div id="editOrgan" class="form-content">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label class="col-xs-3 control-label">单位人数:</label>
                        <div class="col-xs-8">
                            <input type="text" name="employees" id="edit-user-employees" tip="请输入员工人数" class="form-control" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-12">
            ...
            <div id="viewOrgan" class="form-content">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        <label class="col-xs-3 control-label">单位人数:</label>
                        <div class="col-xs-8">
                            <input type="text" name="employees" id="view-user-employees" readonly="readonly" class="form-control" />
                        </div>
                    </div>
                </div>
                <div class="col-sm-12">
