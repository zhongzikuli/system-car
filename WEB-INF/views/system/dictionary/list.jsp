...
<body>
	<div class="mod_header">
		<code>*配置全局的值集，由管理员进行配置</code>
	</div>
	<div class="mod_basic" style="height:auto;">
	    <div class="content">
	...
	<div id="data_dic_rMenu">
	    <ul>
	        <shiro:hasPermission name="dictionary:insert">
	            <li id="data_dic_add" onclick="insertDataDic(this);" parent-id="">添加<li>
	        </shiro:hasPermission>
	        <shiro:hasPermission name="dictionary:update">
	            <li id="data_dic_update" onclick="updateDataDic(this);" parent-id="">修改<li>
	        </shiro:hasPermission>
	        <shiro:hasPermission name="dictionary:delete">
	            <li id="data_dic_delete" onclick="deleteDataDic(this);" parent-id="">删除<li>
	        </shiro:hasPermission>
	        <shiro:hasPermission name="dictionary:getTree">
	            <li id="data_dic_refresh" onclick="refreshTree(this);" parent-id="">刷新<li>
	        </shiro:hasPermission>
	    </ul>
	</div>
</body>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        <input id="dictionary-add-keyWorld" tip="该值不能为空" autocomplete="off"
                                check="validDictForm(this)" class="form-control valid-item valid-input" type="text" name="name" 
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        <input id="dictionary-add-valueDesc" tip="该值不能为空" autocomplete="off"
                                check="validDictForm(this)" type="text" name="name" class="form-control valid-item valid-input"/>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-8">
                        <input id="dictionary-update-keyWorld" tip="该值不能为空" 
                          	check="validDictEditForm(this)" class="form-control valid-item valid-input" type="text" name="name"
