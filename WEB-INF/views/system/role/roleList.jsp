                ...
                <table class="table table-hover table-height table-striped">
                    ...
                    <c:forEach var="item" items="${pageBean.recordList}" varStatus="st">
                        <tr>
                            ...
                            <td class="cel">${item.bak}</td>
                            <td class="cel"><sl:format type="date" pattern="yyyy-MM-dd HH:mm" show="${item.ctime}"/>
                            </td>
                            <td>
        ...
        <form id="createRoleForm" class="form-horizontal">
            <div class="form-group">
                <div class="col-sm-12">
                    ...
                    <div class="col-xs-8">
                        <input type="text" class="form-control" id="create-role-name" tip="请输入角色名称" name="name" autocomplete="off"
