        ...
        <form class="form-horizontal">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="pn-flabel pn-flabel-h col-sm-6">
                            <span class="red">*</span>上传订单Excel文件:
                        </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <div class="pn-flabel pn-flabel-h col-sm-6">
                            <span class="red">*</span>上传订单详情Excel文件:
                        </div>
                        <div class="page-container col-sm-6">
...
<script type="text/javascript" src="${ctx}/js/mine/system/dataImport/dataImport.js?v=222eee"></script>
</html>