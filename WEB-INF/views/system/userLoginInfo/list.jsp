            ...
            <div class="col-sm-12">
                <div class="form-inline">
                    <div class="form-group" id="userLoginInfo_ipAddress">
                        ...
                        <input type="text" class="form-control" name="ipAddress" id="ipAddress" value="${paramMap.ipAddress}">
                    </div>
                    <div class="form-group" id="userLoginInfo_userName">
                        <label class="control-label label">用户姓名:</label>
                        <input type="text" class="form-control" name="userName" id="userName" value="${paramMap.userName}">
                ...
                <table class="table table-hover table-striped">
                    ...
                    <c:forEach var="item" items="${pageBean.recordList}" varStatus="st">
                        <tr>
	                        ...
	                        <td class="cel">${item.ip}</td>
	                        <c:if test="${item.type ==1}">
	                            <td class="cel" id="type_value">pc</td>
	                        </c:if>
	                        <c:if test="${item.type ==2}">
	                            <td class="cel" id="type_value">mobile</td>
	                        </c:if>
	                        <td class="cel">${item.devid}</td>
